<template>
    <validation-observer ref="observer" v-slot="{ handleSubmit }">
        <b-form class="mt-auto" @submit.stop.prevent="handleSubmit(update)">
            ...
            <b-row>
                <b-col cols="12">
                    <validation-provider name="Tipo Junta" :rules="{ required: true, max: 150 }" v-slot="validationContext">
                        <b-form-group id="lbltipojunta" label="Tipo de Junta" label-for="txttipojunta">

                            <b-form-input id="txttipojunta" type="text" v-model="registro.descripcion"
            ...
            <b-row>
                <b-col cols="12">
                    <b-form-checkbox id="lblestatus" v-model="registro.estatusTipoJunta" name="cbxstatus">
                        Registro es Activo
                    </b-form-checkbox>
                </b-col>
...
export default {
    ...
    methods: {
        ...
        getByID() {
            ...
            HTTP.post('api/CatalogoTipoJunta/RegistrobyId', parametros).then(responseApi => {
        ...
        update() {
            ...
            HTTP.post('api/CatalogoTipoJunta/Update', parametros).then(responseApi => {

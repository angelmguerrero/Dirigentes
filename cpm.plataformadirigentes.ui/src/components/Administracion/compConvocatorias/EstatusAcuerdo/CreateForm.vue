<template>
    <validation-observer ref="observer" v-slot="{ handleSubmit }">
        <b-form class="mt-auto" @submit.stop.prevent="handleSubmit(addNew)">
            <b-row>
                <b-col cols="12">
                    <validation-provider name="Estatus Acuerdo"
                                         :rules="{ required: true, max:50 }"
                                         v-slot="validationContext">
                        <b-form-group id="lblEstatusAcuerdo"
                                      label="Estatus Acuerdo"
                                      label-for="txtEstatusAcuerdo">

                            <b-form-input id="txtEstatusAcuerdo"
                                          type="text"
    ...
    export default {
        ...
        methods: {
            ...
            addNew() {
                ...
                HTTP.post('api/CatalogoEstatusAcuerdo/Crear', parametros).then(responseApi => {

<template>
    <validation-observer ref="observer" v-slot="{ handleSubmit }">
        <b-form class="mt-auto" @submit.stop.prevent="handleSubmit(update)">
            ...
            <b-row>
                <b-col cols="12">
                    <validation-provider name="Genero" :rules="{ required: true, max: 20 }" v-slot="validationContext">
                        <b-form-group id="lblgenero" label="Genero" label-for="txtdescripcion">
            ...
            <b-row>
                <b-col cols="12">
                    <b-form-checkbox id="lblestatus" v-model="registro.estatusGenero" name="cbxstatus">
                        Registro es Activo
                    </b-form-checkbox>
                </b-col>
...
export default {
    ...
    methods: {
        ...
        getByID() {
            ...
            HTTP.post('api/CatalogoGenero/RegistrobyId', parametros).then(responseApi => {
        ...
        update() {
            ...
            HTTP.post('api/CatalogoGenero/Update', parametros).then(responseApi => {

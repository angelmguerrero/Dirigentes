<template>
    <validation-observer ref="observer" v-slot="{ handleSubmit }">
        <b-form class="mt-auto" @submit.stop.prevent="handleSubmit(update)">
            ...
            <b-row>
                <b-col cols="12">
                    <validation-provider name="Tipo Baja" :rules="{ required: true, max: 150 }" v-slot="validationContext">
                        <b-form-group id="lblidregistro" label="Tipo Baja" label-for="txtdescripcion">
            ...
            <b-row>
                <b-col cols="12">
                    <b-form-checkbox id="lblestatus" v-model="registro.estatusTipoBaja" name="cbxstatus">
                        Registro es Activo
                    </b-form-checkbox>
                </b-col>
...
export default {
    ...
    methods: {
        ...
        getByID() {
            ...
            HTTP.post('api/CatalogoTipoBaja/RegistrobyId', parametros).then(responseApi => {
        ...
        update() {
            ...
            HTTP.post('api/CatalogoTipoBaja/Update', parametros).then(responseApi => {

<template>
    <b-list-group id="lstNiveles" style="text-align: right;" flush>
        <ul v-for="(nivel, cnt) in niveles" v-bind:key="cnt">
            <li>
                <b-row>
                    <b-col sm="1">
                    ...
                    <b-col sm="8">
                        <b-form-input id="txtNivelPrincipal" type="text" v-model="nivel.descripcion"></b-form-input>
                    </b-col>
                    <b-col sm="3">
                        <b-button-group size="sm">
                            <b-button id="btnEliminarNivel" size="sm" v-if="nivel.indice != 1" variant="outline-danger"
                                @click="deleteNivel(cnt)" style="margin-right: 2px;">
                                <i class="fa-solid fa-minus"></i>
                            </b-button>
                            <b-button id="btnAgregarNivel" size="sm" variant="outline-success" @click="addNivel"
                                v-b-tooltip.hover title="Agregar Nivel" style="margin-right: 2px;">
                                <i class="fa-solid fa-plus"></i>
                            </b-button>
                            <b-button id="btnAgregarSubNivel" size="sm" v-model="nivel.id" class="fa-solid fa-plus"
                                variant="outline-success" @click="addSubNivel(nivel.idConsecutivoPadre, cnt)"
                                v-b-tooltip.hover title="Agregar SubNivel">
                                <i class="fa-solid fa-plus"></i>
                            </b-button>
                        </b-button-group>
                    </b-col>
                </b-row>
                <ul v-for="(subnivel, counter) in niveles[cnt].niveles" v-bind:key="counter">
                    <li>
                        <b-row>
                            <b-col sm="1">
                            ...
                            <b-col sm="8">
                                <b-form-input id="txtNivelPrincipal" type="text"
                                    v-model="subnivel.descripcion"></b-form-input>
                            </b-col>
                            <b-col sm="3">
                                <b-button-group size="sm">
                                    <b-button id="btnEliminarNivel" size="sm" variant="outline-danger"
                                        @click="deleteSubNivel(cnt, counter)" style="margin-right: 2px;">
                                        <i class="fa-solid fa-minus"></i>
                                    </b-button>
                                    <b-button id="btnAgregarSubNivel" size="sm" v-model="subnivel.id"
                                        class="fa-solid fa-plus" variant="outline-success"
                                        @click="addSubNivel2(subnivel.idConsecutivoPadre, cnt, counter)">
                                        <i class="fa-solid fa-plus"></i>
                                    </b-button>
                                </b-button-group>
                            </b-col>
                        </b-row>
                        <ul v-for="(subnivel1, counter1) in niveles[cnt].niveles[counter].niveles" v-bind:key="counter1">
                            <li>
                                <b-row>
                                    <b-col sm="1">
                                    ...
                                    <b-col sm="8">
                                        <b-form-input id="txtNivelPrincipal" type="text"
                                            v-model="subnivel1.descripcion"></b-form-input>
                                    </b-col>
                                    <b-col sm="3">
                                        <b-button-group size="sm">
                                            <b-button id="btnEliminarNivel" size="sm" variant="outline-danger"
                                                @click="deleteSubNivel1(cnt, counter, counter1)" style="margin-right: 2px;">
                                                <i class="fa-solid fa-minus"></i>
                                            </b-button>
                                            <b-button id="btnAgregarSubNivel" size="sm" class="fa-solid fa-plus"
                                                v-model="subnivel1.id" variant="outline-success"
                                                @click="addSubNivel3(subnivel1.idConsecutivoPadre, cnt, counter, counter1)">
                                                <i class="fa-solid fa-plus"></i>
                                            </b-button>
                                        </b-button-group>
                                    </b-col>
                                ...
                                <ul v-for="(subnivel2, counter2) in niveles[cnt].niveles[counter].niveles[counter1].niveles"
                                    ...
                                    <li>
                                        <b-row>
                                            ...
                                            <b-col sm="8">
                                                <b-form-input id="txtNivelPrincipal" type="text"
                                                    v-model="subnivel2.descripcion"></b-form-input>
                                            </b-col>
                                            <b-col sm="3">
                                                <b-button-group size="sm">
                                                    <b-button id="btnEliminarNivel" size="sm" variant="outline-danger"
                                                        @click="deleteSubNivel2(cnt, counter, counter1, counter2)"
                                                        style="margin-right: 2px;">
                                                        <i class="fa-solid fa-minus"></i>
                                                    </b-button>
                                                    <b-button id="btnAgregarSubNivel" size="sm" class="fa-solid fa-plus"
                                                        v-model="subnivel2.id" variant="outline-success"
                                                        @click="addSubNivel4(subnivel2.idConsecutivoPadre, cnt, counter, counter1, counter2)">
                                                        <i class="fa-solid fa-plus"></i>
                                                    </b-button>
                                                </b-button-group>
                                            </b-col>
                                        ...
                                        <ul v-for="(subnivel3, counter3) in niveles[cnt].niveles[counter].niveles[counter1].niveles[counter2].niveles"
                                            ...
                                            <li>
                                                <b-row>
                                                    ...
                                                    <b-col sm="8">
                                                        <b-form-input id="txtNivelPrincipal" type="text"
                                                            v-model="subnivel3.descripcion"></b-form-input>
                                                    </b-col>
                                                    <b-col sm="3">
                                                        <b-button-group size="sm">
                                                            <b-button id="btnEliminarNivel" size="sm"
                                                                variant="outline-danger"
                                                                @click="deleteSubNivel3(cnt, counter, counter1, counter2, counter3)"
                                                                style="margin-right: 2px;">
                                                                <i class="fa-solid fa-minus"></i>
                                                            </b-button>
                                                            <b-button id="btnAgregarSubNivel" size="sm"
                                                                class="fa-solid fa-plus" v-model="subnivel3.id"
                                                                variant="outline-success"
                                                                @click="addSubNivel5(subnivel3.idConsecutivoPadre, cnt, counter, counter1, counter2, counter3)">
                                                                <i class="fa-solid fa-plus"></i>
                                                            </b-button>
                                                        </b-button-group>
                                                    </b-col>
                                                ...
                                                <ul v-for="(subnivel4, counter4) in niveles[cnt].niveles[counter].niveles[counter1].niveles[counter2].niveles[counter3].niveles"
                                                    ...
                                                    <li>
                                                        <b-row>
                                                            ...
                                                            <b-col sm="8">
                                                                <b-form-input id="txtNivelPrincipal" type="text"
                                                                    v-model="subnivel4.descripcion"></b-form-input>
                                                            </b-col>
                                                            <b-col sm="3">
                                                                <b-button id="btnEliminarNivel" size="sm"
                                                                    variant="outline-danger"
                                                                    @click="deleteSubNivel4(cnt, counter, counter1, counter2, counter3, counter4)">
                                                                    <i class="fa-solid fa-minus"></i>
                                                                </b-button>
                                                            </b-col>
                                                        </b-row>
...
export default {
    ...
    data() {
        ...
        mounted() {
            this.niveles = this.detalles;           
            this.getNiveles();
            if(this.update == false){
                this.lastIdPadrePlantilla();
            }            
        },
        methods: {           
            ...
            lastIdPadrePlantilla() {
            debugger
                const parametros = JSON.stringify(this.idTipoJunta);
                HTTP.post('api/Convocatorias/ObtenerIdPadrePlantilla', parametros).then(responseApi => {
